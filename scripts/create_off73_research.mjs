...
const topics = [
  {slug:'offshore-bookkeeping-deposit-in-transit-aging-research', title:'How to study deposit-in-transit aging in bank reconciliation', category:'Bank reconciliation', question:'whether recorded receipts reach the bank statement within an expected window or remain unresolved across reconciliation cutoffs', unit:'one ledger deposit linked to a bank-account reconciliation', event:'a deposit that remains unmatched to bank evidence after the preregistered cutoff', fields:'deposit ID, bank account, entity, ledger date, amount, currency, receipt channel, bank posting date, matching status, exception reason, owner, and evidence link', groups:'bank account, entity, receipt channel, amount band, ledger week, currency, and aging band', exceptions:'weekend batches, processor settlement lags, split deposits, net settlements, reversals, duplicate records, bank-feed gaps, and post-cutoff matches', owner:'treasury or controller', link:'/services/bank-reconciliation-support'},
  {slug:'offshore-bookkeeping-vendor-credit-application-latency-research', title:'How to study vendor-credit application latency', category:'Accounts payable', question:'whether approved vendor credits are applied to eligible invoices promptly or remain open without a supported disposition', unit:'one vendor credit memo or credit balance', event:'elapsed time from evidence-complete credit recognition to supported application, refund, or authorized carryforward', fields:'credit ID, entity, vendor token, credit date, amount, currency, source invoice, eligible invoice, application date, disposition, reviewer, and evidence link', groups:'entity, vendor segment, amount band, currency, source type, disposition, and aging band', exceptions:'disputed credits, cross-entity balances, future purchases, refunds in transit, duplicate credits, partial applications, currency differences, and unavailable invoices', owner:'accounts-payable manager or controller', link:'/services/accounts-payable-processing'},
  {slug:'offshore-bookkeeping-customer-credit-balance-resolution-research', title:'How to study customer credit-balance resolution', category:'Accounts receivable', question:'whether customer credit balances receive timely, supported application, refund, reclassification, or authorized retention decisions', unit:'one customer-account credit balance or separately traceable credit component', event:'a credit balance still lacking a supported disposition after the preregistered cutoff', fields:'credit ID, entity, customer token, origin, amount, currency, creation date, eligible invoice, refund status, disposition date, reviewer, and evidence link', groups:'entity, origin, customer segment, amount band, currency, disposition, and aging band', exceptions:'unapplied receipts, credit memos, disputed invoices, cross-entity customers, partial applications, chargebacks, refunds in transit, and dormant accounts', owner:'accounts-receivable manager or controller', link:'/services/accounts-receivable-support'},
  {slug:'offshore-bookkeeping-prepaid-schedule-exception-research', title:'How to study prepaid-schedule exceptions', category:'Month-end close', question:'whether prepaid-expense schedules remain traceable to source documents, ledger balances, service periods, and approved recognition rules', unit:'one prepaid-schedule line for one reporting period', event:'a line that fails a defined tie-out, source-support, service-period, or approval test at cutoff', fields:'schedule line ID, entity, account, vendor token, invoice ID, original amount, service dates, current amortization, remaining balance, ledger balance, reviewer, and evidence link', groups:'entity, account, expense class, amount band, service-term band, exception type, and aging band', exceptions:'renewals, cancellations, credits, partial service periods, foreign currency, reclassifications, duplicate lines, missing contracts, and post-close adjustments', owner:'close manager or controller', link:'/services/month-end-close-support'},
  {slug:'offshore-bookkeeping-intercompany-confirmation-mismatch-research', title:'How to study intercompany confirmation mismatches', category:'Multi-entity bookkeeping', question:'whether reciprocal intercompany balances are confirmed, explained, and resolved before consolidation or reporting release', unit:'one entity-pair, account, currency, and period confirmation line', event:'a reciprocal balance that differs beyond the approved tolerance or lacks confirmation evidence at cutoff', fields:'period, entity pair, account pair, currency, sender balance, receiver balance, difference, transaction references, confirmation date, resolution status, reviewer, and evidence link', groups:'entity pair, account type, currency, amount band, mismatch reason, confirmation status, and aging band', exceptions:'timing differences, foreign-exchange rates, unmatched recharges, cash in transit, differing charts of accounts, late journals, eliminations, and disputed allocations', owner:'group controller or consolidation owner', link:'/services/month-end-close-support'},
];
...
Create a codebook with observable tests for eligible, achieved, open, returned, excluded, and indeterminate. For this topic, the exception map should explicitly cover ${t.exceptions}. Each state needs required evidence, a decision owner, and a rule for conflicting records. --Done-- is not usable evidence unless the supporting record, decision, and timestamp can be traced.
...
const manifestPath = path.join(process.cwd(),'.paperclip','daily-content',date,'research-off73.json');
