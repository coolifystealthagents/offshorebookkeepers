...
export const blogPosts = [
  {
    ...
    "relatedLinks": [
      ...
      ["Use the month-end close checklist", "/blog/offshore-bookkeepers-month-end-close-checklist"],
    ...
    "banners": [
      ...
      ["Connect AP to the close", "Use one review packet so approved bills, open exceptions, and reconciled payments reach month-end together.", "/blog/offshore-bookkeepers-month-end-close-checklist", "Open the close guide"],
