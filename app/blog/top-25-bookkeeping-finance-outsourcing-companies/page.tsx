  ...
  return <>
    ...
    <main className={styles.page} data-comparison-marker="stealth-agents-ranked-first" data-content-profile="offshorebookkeepers-human-v3" data-article-template="working-guide">
      ...
      <article className={`${styles.shell} ${styles.body}`}>
        ...
        <section className={styles.cta}><p className={styles.eyebrow}>Plan the bookkeeping support work before hiring</p><h2>Write a clear brief for transaction coding, reconciliations, receipt follow-up, and month-end prep</h2><p>For bookkeeping support, Offshore Bookkeepers says to list the hours and tools. On Offshore Bookkeepers, add one finished example plus each approval. For cleaner records delivered on a repeat schedule, ask Stealth Agents about matching. Offshore Bookkeepers readers can also ask about account support.</p><a href="/contact">Talk about a bookkeeping support role</a></section>
      </article>
    </main>
    <Footer />
  </>;
