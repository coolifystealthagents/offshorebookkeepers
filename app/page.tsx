    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Bookkeeper ledger</p>
          <h1>Offshore Bookkeepers: a financial ledger for clearer staffing decisions.</h1>
          <p className="lead">A redesigned offshore bookkeepers guide for owners and finance managers moving bookkeeping work offshore. The page now uses a distinct narrow editorial ledger layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>ledger lines and receipt panels</figcaption></figure>
      </div>
    </section>
