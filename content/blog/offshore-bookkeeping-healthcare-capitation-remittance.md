---
title: "Reconcile healthcare capitation rosters, remittances, and adjustments"
description: "A practical offshore bookkeeping workflow for capitation remittances, with evidence, exception ownership, and clear review boundaries."
...
## Why capitation remittances needs a dedicated workpaper

The records for capitation remittances rarely arrive in one system or at one time. A dependable packet connects the payer contract summary, eligibility roster, member-month file, remittance, retroactive adjustment report, bank deposit, claim offset, and receivable ledger. Posting a final bank amount alone removes the trail needed to explain timing, deductions, ownership, and unresolved differences.
