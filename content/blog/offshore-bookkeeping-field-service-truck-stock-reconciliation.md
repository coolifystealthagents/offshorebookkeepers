---
title: "Reconcile field-service truck stock to work orders and replenishment"
description: "Connect parts issued to technicians, work-order use, returns, transfers, write-offs, and warehouse replenishment."
published: "2026-09-19"
updated: "2026-09-19"
category: "Service business bookkeeping"
type: "blog"
featuredImage: "/thumbnails/bookkeeping-quality-scorecard.webp"
sources: [{"name":"IRS inventory guidance","url":"https://www.irs.gov/publications/p538"},{"name":"NIST asset management control","url":"https://csrc.nist.gov/projects/risk-management/sp800-53-controls/release-search#/control?version=5.1&number=CM-8"}]
...
Parts carried in service vehicles move outside the main warehouse workflow. Items may be consumed on a job, returned, transferred between technicians, replaced under warranty, or remain unreported until the vehicle count.
...
Useful background for designing the procedure includes [IRS inventory guidance](https://www.irs.gov/publications/p538) and [NIST asset management control](https://csrc.nist.gov/projects/risk-management/sp800-53-controls/release-search#/control?version=5.1&number=CM-8). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain vehicle, technician, part number, opening quantity, warehouse issue, work order, used quantity, return, transfer, warranty part, count quantity, variance, evidence, and owner. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the truck-stock rollforward
...
A truck opens with 40 filters, receives 20, records 43 used on work orders, returns 4, and counts 11. The expected count is 13, so two units remain an exception until transfer or usage evidence is found.
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires inventory valuation, loss determination, write-off approval, and technician accountability. That decision belongs to the service manager and finance owner.
