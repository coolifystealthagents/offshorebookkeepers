---
title: "Reconcile restaurant private-event minimums, deposits, and final settlement"
description: "A practical offshore bookkeeping workflow for private-event minimums and deposits, with complete populations, evidence, exception ownership, and review boundaries."
...
## Why private-event minimums and deposits needs a dedicated workpaper

The records for private-event minimums and deposits rarely live in one system or arrive at the same time. A dependable packet connects the signed event agreement, booking record, deposit receipt, change order, final check, cancellation record, refund approval, processor settlement, and customer ledger. Posting only the final net amount removes the trail needed to explain timing, ownership, deductions, approvals, and unresolved differences.
...
An event requires a $6,000 deposit and a $15,000 minimum spend. The final check is $14,200 before an $800 minimum adjustment, and the processor nets a $350 fee. The rollforward separates the customer balance from settlement fees and cash timing.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/restaurant-bookkeeping). If your company needs a Philippines-based bookkeeper to maintain this schedule while its finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
