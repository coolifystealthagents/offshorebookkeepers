---
title: "Track agency client media prepayments from receipt to campaign spend"
description: "Reconcile client advances, approved media plans, platform spend, fees, refunds, and remaining client balances."
published: "2026-09-19"
updated: "2026-09-19"
category: "Agency bookkeeping"
type: "blog"
featuredImage: "/thumbnails/offshore-bookkeeping-project-margin-bridge.webp"
sources: [{"name":"FTC digital advertising guidance","url":"https://www.ftc.gov/business-guidance/advertising-marketing/online-advertising-marketing"},{"name":"IRS recordkeeping guidance","url":"https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping"}]
...
An agency may receive client cash before buying media, then spend across platforms, campaigns, currencies, and billing periods. Without a client-level rollforward, unspent funds can be confused with agency revenue or one client’s cash can appear to fund another campaign.
...
Useful background for designing the procedure includes [FTC digital advertising guidance](https://www.ftc.gov/business-guidance/advertising-marketing/online-advertising-marketing) and [IRS recordkeeping guidance](https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
## Build the client media prepayment rollforward
...
A client advances $50,000. Approved platform spend is $41,000, a platform credit returns $2,500, and a separately approved agency fee is $4,000. The rollforward shows the remaining client-controlled amount rather than treating the full receipt as earned.
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires revenue recognition, contract interpretation, use of client funds, refunds, and fee approval. That decision belongs to the account lead and finance owner.
