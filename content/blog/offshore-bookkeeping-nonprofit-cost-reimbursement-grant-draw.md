...
sources: [{"name":"Uniform Guidance cost principles","url":"https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-E"},{"name":"Uniform Guidance financial management standards","url":"https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-D/section-200.302"}]
...
A cost-reimbursement grant converts approved spending into a reimbursement request. The general ledger may show total program cost, but the draw also needs grant-period, eligibility, allocation, match, prior-claim, and document checks.
...
Useful background for designing the procedure includes [Uniform Guidance cost principles](https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-E) and [Uniform Guidance financial management standards](https://www.ecfr.gov/current/title-2/subtitle-A/chapter-II/part-200/subpart-D/section-200.302). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain grant, budget category, vendor or employee, transaction date, service period, account, amount, allocation basis, eligible share, match share, prior draw status, source link, and approval status. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the grant draw evidence packet
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires cost allowability, allocation methodology, match acceptance, and certification of the draw. That decision belongs to the grant manager and authorized certifier.
