---
title: "Reconcile subcontractor retainage from pay application to release"
description: "Track approved work, retainage withheld, change orders, prior payments, lien support, and final release."
published: "2026-09-19"
updated: "2026-09-19"
category: "Construction bookkeeping"
type: "blog"
featuredImage: "/thumbnails/construction-job-costing-control-research.webp"
sources: [{"name":"FAR retainage guidance","url":"https://www.acquisition.gov/far/32.103"},{"name":"AIA payment application overview","url":"https://www.aiacontracts.com/articles/183616-g702-1992-application-and-certificate-for-payment/"}]
...
Subcontractor pay applications often separate current work, approved change orders, stored materials, retainage, and previous payments. Retainage can be misstated when a revised rate or partial release is applied without a project-level rollforward.
...
Useful background for designing the procedure includes [FAR retainage guidance](https://www.acquisition.gov/far/32.103) and [AIA payment application overview](https://www.aiacontracts.com/articles/183616-g702-1992-application-and-certificate-for-payment/). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain project, subcontractor, contract, change order, pay application, completed work, stored materials, retainage rate, retainage withheld, prior release, current release, lien support, and approval. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the subcontractor retainage rollforward
...
A subcontract is $500,000 plus a $40,000 approved change order. Cumulative earned work is $360,000 at 10% retainage, but the current application shows only $28,000 retained after an unsupported partial release. The rollforward isolates the $8,000 difference.
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires work certification, lien compliance, retainage release, and payment authorization. That decision belongs to the project manager and authorized contract approver.
