---
title: "Reconcile property capital-reserve contributions and spending"
description: "Trace owner contributions, approved reserve uses, vendor invoices, transfers, and remaining restricted balances by property."
published: "2026-09-19"
updated: "2026-09-19"
category: "Property bookkeeping"
type: "blog"
featuredImage: "/thumbnails/property-bookkeeping-rent-roll-controls.webp"
sources: [{"name":"HUD reserve guidance","url":"https://www.hud.gov/hud-partners/multifamily-financial-management"},{"name":"IRS rental property guidance","url":"https://www.irs.gov/publications/p527"}]
...
Useful background for designing the procedure includes [HUD reserve guidance](https://www.hud.gov/hud-partners/multifamily-financial-management) and [IRS rental property guidance](https://www.irs.gov/publications/p527). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain property, reserve account, opening balance, owner contribution, approval reference, capital project, vendor invoice, transfer date, reserve-funded amount, operating-funded amount, remaining commitment, and exception owner. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the capital-reserve rollforward
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires capitalization, permitted reserve use, funding approval, and owner allocation. That decision belongs to the property manager and finance owner.
