---
title: "Tie marketplace sales-tax collections to settlements and liabilities"
description: "A practical offshore bookkeeping workflow for marketplace sales-tax activity, with evidence, exception ownership, and clear review boundaries."
...
## Why marketplace sales-tax activity needs a dedicated workpaper

The records for marketplace sales-tax activity rarely arrive in one system or at one time. A dependable packet connects the order export, jurisdiction report, marketplace statement, refund file, settlement report, bank deposit, filed return, and tax-liability ledger. Posting a final bank amount alone removes the trail needed to explain timing, deductions, ownership, and unresolved differences.
...
Orders show $14,800 of tax, the marketplace remits $12,900 directly, and settlements include $1,600 collected by the seller. Refunds reverse another $300. The bridge identifies which party collected each amount before anyone prepares a filing.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/ecommerce-bookkeeping). If your company needs a Philippines-based bookkeeper to maintain this schedule while your finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
