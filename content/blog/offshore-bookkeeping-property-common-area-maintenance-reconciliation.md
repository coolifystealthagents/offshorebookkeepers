---
title: "Prepare a property CAM reconciliation for tenant review"
description: "A practical offshore bookkeeping workflow for common-area maintenance activity, with complete populations, evidence, exception ownership, and review boundaries."
...
## Why common-area maintenance activity needs a dedicated workpaper

The records for common-area maintenance activity rarely live in one system or arrive at the same time. A dependable packet connects the lease abstract, tenant roster, approved budget, vendor invoices, allocation basis, occupancy schedule, payments, prior billings, and property ledger. Posting only the final net amount removes the trail needed to explain timing, ownership, deductions, approvals, and unresolved differences.
...
Recoverable costs total $420,000. A tenant has a 7.5% share, paid $28,000 in estimates, and disputes $6,000 of capital work included in the pool. The schedule shows the calculation and isolates the disputed classification.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/property-bookkeeping). If your company needs a Philippines-based bookkeeper to maintain this schedule while its finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
