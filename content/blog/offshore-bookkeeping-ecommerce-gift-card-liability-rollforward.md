---
title: "Roll forward ecommerce gift-card sales, redemptions, and refunds"
description: "A practical offshore bookkeeping workflow for gift-card liabilities, with complete populations, evidence, exception ownership, and review boundaries."
...
## Why gift-card liabilities needs a dedicated workpaper

The records for gift-card liabilities rarely live in one system or arrive at the same time. A dependable packet connects the gift-card platform export, order report, redemption file, refund report, processor settlement, expiration policy, jurisdiction review, and liability ledger. Posting only the final net amount removes the trail needed to explain timing, ownership, deductions, approvals, and unresolved differences.
...
Customers buy $84,000 of gift cards, redeem $51,000, and receive $3,000 of approved refunds. The platform also reports $1,200 of promotional cards. The rollforward separates cash-funded value from promotions before any recognition decision.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/ecommerce-bookkeeping). If your company needs a Philippines-based bookkeeper to maintain this schedule while its finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
