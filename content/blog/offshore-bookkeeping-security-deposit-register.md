---
title: "Maintain a security deposit register across locations and counterparties"
description: "A practical workflow for security deposits, evidence control, exceptions, and owner review."
...
A useful security deposits workpaper must let a reviewer reconstruct what entered the schedule, what changed, and what remains open. Record the entity, account, period, currency, source systems, preparer, reviewer, and cutoff. For this workflow, make the counterparty index the named control focus. The bookkeeper owns disciplined assembly; the legal or property owner keeps authority over refund entitlement and deduction.
...
The expected packet includes executed agreement, payment record, location schedule, refund notice, deduction support, and ledger balance. Give each record a stable reference and capture source, effective date, amount, currency, owner, and approved storage location. Mark unavailable evidence as missing rather than substituting an assumption. Sensitive files should stay in access-controlled systems.
...
The preparer may reproduce arithmetic, compare observable fields, and draft a question. The preparer should not invent support or decide refund entitlement and deduction. Route that question to the legal or property owner with the evidence reference and the exact decision requested. Record the response and approval under the client policy.
...
Retain the scope statement, original exports, evidence index, movement bridge, exception register, reviewer notes, approvals, and change log. Carry forward only genuinely open items. A complete security deposits packet explains the population, evidence, movements, exceptions, and decisions without requiring the next reviewer to reconstruct the story from messages.
