---
title: "Reconcile marketplace sales tax withheld to orders and payouts"
description: "Tie marketplace-facilitator tax, refunds, fees, orders, and cash without posting a net payout as revenue."
published: "2026-09-19"
updated: "2026-09-19"
category: "Ecommerce bookkeeping"
type: "blog"
featuredImage: "/thumbnails/ecommerce-bookkeeping-reconciliation-workflow.webp"
sources: [{"name":"Streamlined Sales Tax marketplace resources","url":"https://www.streamlinedsalestax.org/for-businesses/marketplace-facilitator"},{"name":"IRS recordkeeping guidance","url":"https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping"}]
...
Useful background for designing the procedure includes [Streamlined Sales Tax marketplace resources](https://www.streamlinedsalestax.org/for-businesses/marketplace-facilitator) and [IRS recordkeeping guidance](https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain marketplace, jurisdiction, order, transaction date, gross sale, discount, shipping, tax collected, facilitator-withheld tax, seller-remitted tax, refund, fee, payout, and exception. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the marketplace tax and payout bridge
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires taxability, nexus, return treatment, and adjustment approval. That decision belongs to the tax adviser and ecommerce finance owner.
