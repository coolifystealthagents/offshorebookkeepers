---
title: "Roll forward nonprofit pledges, restrictions, collections, and write-offs"
description: "A practical offshore bookkeeping workflow for nonprofit pledge receivables, with evidence, exception ownership, and clear review boundaries."
...
## Why nonprofit pledge receivables needs a dedicated workpaper

The records for nonprofit pledge receivables rarely arrive in one system or at one time. A dependable packet connects the signed pledge, donor restriction, campaign roster, installment schedule, cash receipt, modification notice, aging report, and fund ledger. Posting a final bank amount alone removes the trail needed to explain timing, deductions, ownership, and unresolved differences.
...
A campaign records $180,000 of pledges. Collections total $132,000, a donor modifies $10,000 in writing, and $8,000 is overdue without a decision. The rollforward shows each movement without assuming collectibility or restriction treatment.
