---
title: "Review stale checks during bank reconciliation without hiding open liabilities"
description: "A practical offshore bookkeeping workflow for stale and outstanding checks, with complete populations, evidence, exception ownership, and review boundaries."
...
## Why stale and outstanding checks needs a dedicated workpaper

The records for stale and outstanding checks rarely live in one system or arrive at the same time. A dependable packet connects the bank statement, check register, payee record, invoice, void history, stop-payment evidence, unclaimed-property review, and general ledger. Posting only the final net amount removes the trail needed to explain timing, ownership, deductions, approvals, and unresolved differences.
...
The register contains 18 checks older than 90 days totaling $31,400. Two cleared after cutoff, five have documented replacements, and eleven still need payee and policy review. The schedule keeps each liability open until an authorized decision is supported.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/bank-reconciliation-support). If your company needs a Philippines-based bookkeeper to maintain this schedule while its finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
