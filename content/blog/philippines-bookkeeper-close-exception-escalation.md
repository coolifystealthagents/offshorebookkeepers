---
title: "Close exception escalation for a Philippines bookkeeper"
description: "Use decision-focused escalation rules so Philippines bookkeeping support can keep a close moving without hiding unresolved accounting or source problems."
published: "2026-08-17"
updated: "2026-08-17"
category: "Month-End Close"
type: "blog"
featuredImage: "/thumbnails/close-exception-log-bookkeeping.webp"
takeaways: ["Describe the blocked task and evidence before escalating.","Route policy, approval, and missing-source questions to the correct owner.","Preserve the original exception and decision for later review."]
faqs: [["When should a bookkeeper escalate?","Escalate when a missing source, policy question, approval, unusual balance, or system issue prevents a documented next step."],["What makes an escalation actionable?","It names the account or item, amount, evidence checked, specific question, owner, deadline, and consequence of waiting."]]
---
