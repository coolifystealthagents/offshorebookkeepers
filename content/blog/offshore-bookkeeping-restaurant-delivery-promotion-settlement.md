---
title: "Reconcile restaurant delivery-platform promotions to settlements"
description: "Separate restaurant-funded discounts, platform-funded promotions, commissions, refunds, tips, taxes, and cash."
published: "2026-09-19"
updated: "2026-09-19"
category: "Restaurant bookkeeping"
type: "blog"
featuredImage: "/thumbnails/bookkeeping-customer-deposit-reconciliation.webp"
sources: [{"name":"FTC advertising guidance","url":"https://www.ftc.gov/business-guidance/advertising-marketing"},{"name":"IRS tip recordkeeping guidance","url":"https://www.irs.gov/businesses/small-businesses-self-employed/tip-recordkeeping-and-reporting"}]
...
Delivery platforms may display one customer discount while allocating its cost between the restaurant and platform. Net settlements can also include commissions, delivery fees, taxes, tips, refunds, and adjustments from earlier orders.
...
Useful background for designing the procedure includes [FTC advertising guidance](https://www.ftc.gov/business-guidance/advertising-marketing) and [IRS tip recordkeeping guidance](https://www.irs.gov/businesses/small-businesses-self-employed/tip-recordkeeping-and-reporting). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain platform, location, order, order date, menu subtotal, customer discount, restaurant-funded promotion, platform-funded promotion, tax, tip, commission, refund, settlement, and status. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the delivery-promotion settlement bridge
...
A weekly report shows $18,000 of menu sales and $2,400 of customer discounts. The platform funds $1,500, the restaurant funds $900, commissions are $3,060, and refunds are $440. The bridge explains each component before tying to cash.
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires revenue presentation, tax, tip ownership, promotion classification, and dispute approval. That decision belongs to the restaurant controller and operations owner.
...
For help defining the underlying role, see [Bank and Credit Card Reconciliation Support](/services/bank-reconciliation-support). If your team needs a Philippines-based bookkeeper to prepare schedules, maintain evidence, and route exceptions while your finance owner keeps approval, [plan the role with Offshore Bookkeepers](/contact-us).
