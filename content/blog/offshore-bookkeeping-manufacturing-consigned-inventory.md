---
title: "Reconcile consigned inventory across locations, usage, and billing"
description: "A practical offshore bookkeeping workflow for consigned inventory, with evidence, exception ownership, and clear review boundaries."
...
## Why consigned inventory needs a dedicated workpaper

The records for consigned inventory rarely arrive in one system or at one time. A dependable packet connects the consignment agreement, item master, shipment record, location count, usage report, return record, supplier invoice, and inventory ledger. Posting a final bank amount alone removes the trail needed to explain timing, deductions, ownership, and unresolved differences.
...
Records show 4,200 units sent to three locations, 2,900 consumed, and 900 counted on hand. Returns explain 250 units, leaving 150 units unresolved. The bridge preserves ownership and location evidence instead of forcing a quantity adjustment.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/inventory-cost-data-support). If your company needs a Philippines-based bookkeeper to maintain this schedule while your finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
