---
title: "Reassociate healthcare ERA remittances with EFT deposits"
description: "Match payer remittance files, claim adjustments, patient responsibility, recoupments, and bank deposits while limiting protected data."
published: "2026-09-19"
updated: "2026-09-19"
category: "Healthcare bookkeeping"
type: "blog"
featuredImage: "/thumbnails/clinic-bookkeeping-reconciliation-research.webp"
sources: [{"name":"CMS ERA and EFT operating rules","url":"https://www.cms.gov/priorities/key-initiatives/burden-reduction/administrative-simplification/transactions/health-care-payment-remittance-advice"},{"name":"HHS minimum necessary guidance","url":"https://www.hhs.gov/hipaa/for-professionals/privacy/guidance/minimum-necessary-requirement/index.html"}]
...
Electronic remittance advice and electronic funds transfer can arrive through different systems and on different dates. One deposit may cover many claims, while recoupments and provider-level adjustments prevent claim totals from equaling cash.
...
Useful background for designing the procedure includes [CMS ERA and EFT operating rules](https://www.cms.gov/priorities/key-initiatives/burden-reduction/administrative-simplification/transactions/health-care-payment-remittance-advice) and [HHS minimum necessary guidance](https://www.hhs.gov/hipaa/for-professionals/privacy/guidance/minimum-necessary-requirement/index.html). These sources do not replace the company’s contracts, accounting policy, or professional advice. Record the version and access date when a changing rule or provider document affects the workflow.
...
The working table should contain payer, trace number, deposit date, remittance date, restricted claim reference, allowed amount, payer amount, patient responsibility, adjustment code, recoupment, provider adjustment, and exception owner. Use stable references instead of names where confidentiality requires it. Never delete unmatched rows merely because they make the schedule untidy. A missing record is an exception with an owner, not permission to invent a value.
...
## Build the ERA-to-EFT reassociation
...
An EFT deposits $24,800. The ERA lists $26,000 of claim payments, a $900 prior-period recoupment, and a $300 provider adjustment. The reassociation proves the cash total while keeping claim-level differences available for billing review.
...
The offshore bookkeeper can download approved reports, compare identifiers and amounts, reperform arithmetic, request missing documents, update statuses, and draft a proposed entry for review. The bookkeeper should stop when the work requires coding, appeal, write-off, patient billing, and access to protected information. That decision belongs to the revenue-cycle lead and clinic finance owner.
