---
title: "Reconcile law-firm client advances and matter costs"
description: "A practical offshore bookkeeping workflow for client advances and matter costs, with evidence, exception ownership, and clear review boundaries."
published: "2026-09-24"
updated: "2026-09-24"
category: "Legal bookkeeping"
type: "blog"
...
## Why client advances and matter costs needs a dedicated workpaper

The records for client advances and matter costs rarely arrive in one system or at one time. A dependable packet connects the engagement terms, matter roster, client deposit, vendor invoice, cost ledger, trust transfer evidence, client bill, reimbursement, and general ledger. Posting a final bank amount alone removes the trail needed to explain timing, deductions, ownership, and unresolved differences.
...
A client advances $20,000. Approved filing and expert costs total $12,600, but the matter ledger contains a $1,900 vendor charge with no matter identifier. The reconciliation leaves that cost unallocated until the responsible attorney reviews it.
...
For help defining the preparation lane, see [the relevant Offshore Bookkeepers service](/services/legal-bookkeeping). If your company needs a Philippines-based bookkeeper to maintain this schedule while your finance owner retains approval, [plan the role with Offshore Bookkeepers](/contact-us).
