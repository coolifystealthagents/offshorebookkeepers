---
title: "Source-export reproducibility for remote bookkeeping workpapers"
description: "An evidence-led study framework for source-export reproducibility, measurement choices, boundaries, and limitations."
...
---
Published September 2, 2026. This Research article examines whether saved filters, timestamps, and control totals make bookkeeping populations easier to reproduce.

## Research question and context

The study asks whether saved filters, timestamps, and control totals make bookkeeping populations easier to reproduce? Distributed bookkeeping separates preparation, review, evidence ownership, and protected decisions. The proposed reproduction test observes that handoff without treating speed, agreement, or a zero balance as proof of correctness.

## Evidence basis

GAO and COSO support clear responsibility, useful information, control activities, and monitoring. PCAOB and AICPA evidence concepts distinguish relevance and reliability without turning bookkeeping into an audit. NIST supports integrity and access control; IRS supports explanatory records. FASB, IFRS, and SBA add financial-information and small-business context. None establishes a universal benchmark for source-export reproducibility.

## Unit of observation

Use one reviewable reconciliation line, evidence packet, exception, or close task with a defined preparer and reviewer. Capture report name, filter set, extraction time, row count, control total, and rerun variance. Also record entity, period, source system, complexity, and whether a protected decision was required. Freeze the denominator before analysis.
