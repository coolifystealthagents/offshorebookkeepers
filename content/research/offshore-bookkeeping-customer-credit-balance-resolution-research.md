---
title: "How to study customer credit-balance resolution"
description: "A reproducible study protocol for whether customer credit balances receive timely, supported application, refund, reclassification, or authorized retention decisions, with frozen populations, evidence coverage, decision rights, and limitations."
...
Create a codebook with observable tests for eligible, achieved, open, returned, excluded, and indeterminate. For this topic, the exception map should explicitly cover unapplied receipts, credit memos, disputed invoices, cross-entity customers, partial applications, chargebacks, refunds in transit, and dormant accounts. Each state needs required evidence, a decision owner, and a rule for conflicting records. --Done-- is not usable evidence unless the supporting record, decision, and timestamp can be traced.
