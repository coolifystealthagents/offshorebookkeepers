---
title: "How should unmatched cash aging be measured across receipt channels?"
description: "A bounded research framework for unmatched cash aging, measurement choices, safeguards, and limitations."
published: "2026-09-08"
updated: "2026-09-08"
category: "Bookkeeping research"
type: "research"
featuredImage: "/thumbnails/bookkeeping-merchant-reserve-reconciliation.webp"
sources: [{"name":"U.S. GAO, Standards for Internal Control in the Federal Government","url":"https://www.gao.gov/products/gao-14-704g"},{"name":"COSO, Internal Control Framework","url":"https://www.coso.org/internal-control"},{"name":"PCAOB, AS 1105: Audit Evidence","url":"https://pcaobus.org/oversight/standards/auditing-standards/details/AS1105"},{"name":"NIST, Data Integrity glossary","url":"https://csrc.nist.gov/glossary/term/data_integrity"},{"name":"IRS, Recordkeeping","url":"https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping"},{"name":"FASB, Concepts Statements","url":"https://www.fasb.org/page/PageContent?pageId=/standards/concepts-statements.html"},{"name":"IFRS Foundation, Conceptual Framework","url":"https://www.ifrs.org/issued-standards/list-of-standards/conceptual-framework/"},{"name":"U.S. Small Business Administration, Manage your finances","url":"https://www.sba.gov/business-guide/manage-your-business/manage-your-finances"},{"name":"NIST, Role Based Access Control","url":"https://csrc.nist.gov/projects/role-based-access-control"},{"name":"AICPA & CIMA, Audit evidence","url":"https://www.aicpa-cima.com/resources/article/audit-evidence"}]
...
---
Published September 8, 2026. This research brief offers an operational study design. It is not accounting, audit, tax, legal, payroll, statistical, investment, or regulatory advice.

## Research question

This brief asks how long receipts remain unmatched when the starting event and resolution rule are defined consistently. An evidence request is not complete merely because someone replied. The response still has to contain the record that the procedure called for.

The cited public materials support traceable records, assigned responsibilities, controlled access, and reviewable evidence. The proposed application to unmatched cash aging is OffshoreBookkeepers.com analysis, not a finding reported by those sources.

## Define the population before looking at results

Choose one recurring process and a fixed run of consecutive periods. The observation unit should be one request, workpaper, mapping change, vendor, or close task with a named preparer and reviewer. Capture receipt ID, channel, received time, available remittance, first match attempt, resolution time, and outcome. Record the entity, period, source system, and any authorized judgment involved. Write inclusion and exclusion rules before calculating the measure.
