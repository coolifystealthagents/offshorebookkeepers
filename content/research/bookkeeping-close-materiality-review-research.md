---
title: "Close materiality review: research on prioritizing unresolved bookkeeping items"
description: "Research on ranking close exceptions by decision impact, evidence quality, recurrence, and owner rather than by amount alone."
published: "2026-08-14"
updated: "2026-08-14"
category: "Close Review"
type: "research"
featuredImage: "/thumbnails/month-end-close-cycle-time-benchmarks.webp"
takeaways: ["Materiality is decision context, not only a numeric cutoff.", "Small recurring errors can matter through accumulation.", "Open-item age and owner belong beside the proposed accounting treatment."]
sources: [{"name":"FASB, Concepts Statement No. 8","url":"https://asc.fasb.org/"},{"name":"PCAOB AS 2101, Audit Planning","url":"https://pcaobus.org/oversight/standards/auditing-standards/details/AS2101"},{"name":"GAO, Standards for Internal Control","url":"https://www.gao.gov/products/gao-14-704g"},{"name":"SEC, Staff Accounting Bulletin No. 99","url":"https://www.sec.gov/interps/account/sab99.htm"},{"name":"IRS, Recordkeeping","url":"https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping"},{"name":"COSO, Internal Control Framework","url":"https://www.coso.org/internal-control"},{"name":"PCAOB AS 1215","url":"https://pcaobus.org/oversight/standards/auditing-standards/details/AS1215"},{"name":"SEC, Accounting and Auditing","url":"https://www.sec.gov/page/accounting-and-auditing"},{"name":"SBA, Manage Your Business","url":"https://www.sba.gov/business-guide/manage-your-business"},{"name":"NIST SP 800-53 Rev. 5","url":"https://csrc.nist.gov/pubs/sp/800/53/r5/upd1/final"}]
relatedLinks: [["/research/bookkeeping-month-end-close-exception-research","/research/month-end-close-cycle-time-benchmarks"]]
faqs: [{"question":"Is a small amount always immaterial?","answer":"No. Context, aggregation, nature, trend, control effect, and decision use can make a small item important."},{"question":"Who decides disposition?","answer":"The authorized finance owner decides treatment; bookkeeping support prepares evidence and tracks the decision."}]
---
## Research question
