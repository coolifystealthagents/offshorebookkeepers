---
title: "What a dormant-vendor review can and cannot tell you"
description: "A bounded research framework for dormant vendor population, measurement choices, safeguards, and limitations."
...
This brief asks whether a defined inactivity rule produces a reviewable vendor population. Dormant does not mean improper. It is a defined population for review, and the definition has to be visible beside the result.

The cited public materials support traceable records, assigned responsibilities, controlled access, and reviewable evidence. The proposed application to dormant vendor population is OffshoreBookkeepers.com analysis, not a finding reported by those sources.

## Define the population before looking at results

Choose one recurring process and a fixed run of consecutive periods. The observation unit should be one request, workpaper, mapping change, vendor, or close task with a named preparer and reviewer. Capture vendor ID, last transaction, open balance, payment status, master-data change, owner, and review outcome. Record the entity, period, source system, and any authorized judgment involved. Write inclusion and exclusion rules before calculating the measure.
