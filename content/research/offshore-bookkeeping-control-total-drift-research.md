---
title: "Control-total drift across repeated bookkeeping exports"
description: "An evidence-led research framework for control-total drift, including measurement choices and limitations."
...
---
Published September 4, 2026. This Research article examines how often saved source-report control totals change when teams rerun the same period and filters.

## The question worth measuring

The proposed study asks how often saved source-report control totals change when teams rerun the same period and filters? A changed total may come from late activity, a revised source record, or an inconsistent export procedure. The design therefore records context and exceptions instead of reducing the workflow to one performance score.

## What the public sources support

GAO and COSO describe responsibility, useful information, control activities, and monitoring. PCAOB and AICPA materials discuss the relevance and reliability of evidence; those concepts do not turn a bookkeeping study into an audit. NIST covers data integrity and role-based access. IRS recordkeeping guidance, FASB concepts, the IFRS Conceptual Framework, and SBA material provide additional context for financial records. None of these sources publishes a universal benchmark for control-total drift.

## Define the observation first

Use one reviewable task, reconciliation, evidence packet, or exception with a known preparer and reviewer. Capture report name, saved filters, extraction time, row count, amount total, source revision, and variance. Record the entity, period, source system, complexity, and whether the work required an authorized judgment. Set inclusion and exclusion rules before looking at results.
...
The public sources support traceable records, clear responsibilities, access control, and reviewable evidence. Applying those principles to control-total drift is OffshoreBookkeepers.com operational analysis. Any claim that a process change improves an outcome is an inference until local data tests it.
